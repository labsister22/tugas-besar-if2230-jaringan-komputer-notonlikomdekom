...
class ChatClientCurses:
    ...
    def _process_typed_message(self, message):
        ...
        if message.startswith("!kill "):
            ...
            payload = self.create_json_payload(self.CLIENT_NAME, "kill", password)
    ...
    def listen_for_messages(self):
        while self.running:
            try:
                ...
                # For now, assuming recv() might block for a while.
                # A more robust way is for self.sock.recv() to accept a timeout.
                ...
                msg_bytes = self.sock.recv() # This might block
